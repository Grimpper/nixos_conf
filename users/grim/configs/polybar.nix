  ...
  services.polybar = {
    ...
    config = {
      ...
      "bar/top" = {
        ...
        font-0 = "Meslo Patched:size=12;3";
        font-1 = "Meslo Patched:style=Bold:size=12;3";
        font-2 = "FuraCode Nerd Font:style=Bold:size=12;3";

        modules-left = "distro-icon bspwm";
      ...
      "module/bspwm" = {
        ...
        label-occupied-foreground = primary;
        ...
        label-empty-foreground = tertiary;
